...
figure; pcolor(lon_wg,lat_wg,cafe_npp_tot_gC_nans_8day(:,:,26)); shading flat
...
save cafe_8day_imported_May22 -v7.3
...
cafe_npp_all_8day=cat(3,cafe_npp_all_8day,cafe_new);
